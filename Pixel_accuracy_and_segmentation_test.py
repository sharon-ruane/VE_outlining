...
if __name__ == '__main__':
    ...
    model_dir = "/home/iolie/PycharmProjects/THESIS/savedmodels_unet_26/titletraining_weightsatloss_0.35"
    main_dir = "/home/iolie/Desktop/THESIS IMAGES/"
    save_dir = os.path.join(main_dir, model_dir.split("/")[-1])
    ...
    pixel_and_cell_count_test(raw_image_batch, ground_truth_batch, model_dir, save_dir, demo = False, rsz = (96,96), batch_size =2)
